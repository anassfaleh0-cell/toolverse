          ...
          <Card variant="default" className="p-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className={`rounded-lg p-4 ${criteria.aaNormal ? "bg-emerald-50 dark:bg-emerald-950/30" : "bg-red-50 dark:bg-red-950"}`}>
                ...
                <p className={`mt-1 text-lg font-bold ${criteria.aaNormal ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}>
              ...
              <div className={`rounded-lg p-4 ${criteria.aaLarge ? "bg-emerald-50 dark:bg-emerald-950/30" : "bg-red-50 dark:bg-red-950"}`}>
                ...
                <p className={`mt-1 text-lg font-bold ${criteria.aaLarge ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}>
              ...
              <div className={`rounded-lg p-4 ${criteria.aaaNormal ? "bg-emerald-50 dark:bg-emerald-950/30" : "bg-red-50 dark:bg-red-950"}`}>
                ...
                <p className={`mt-1 text-lg font-bold ${criteria.aaaNormal ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}>
              ...
              <div className={`rounded-lg p-4 ${criteria.aaaLarge ? "bg-emerald-50 dark:bg-emerald-950/30" : "bg-red-50 dark:bg-red-950"}`}>
                ...
                <p className={`mt-1 text-lg font-bold ${criteria.aaaLarge ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}>
