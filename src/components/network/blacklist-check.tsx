            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="mt-2 flex items-center gap-3">
                  <span className={`text-2xl font-bold ${result.listedCount === 0 ? "text-green-600" : "text-red-600"}`}>{result.listedCount}</span>
            ...
            {result.results.map((bl, i) => (
              <div key={i} className="flex items-center justify-between px-5 py-3">
                <div className="flex items-center gap-3">
                  <span className={`flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-bold ${bl.listed ? "bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-300" : "bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-300"}`}>
                    {bl.listed ? "!" : "✓"}
                  </span>
                  <div>
                ...
                <span className={`text-xs font-medium ${bl.listed ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"}`}>
