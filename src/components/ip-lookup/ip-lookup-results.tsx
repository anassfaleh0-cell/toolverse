...
export function IpLookupResults({
  ...
  const rows = [
    ...
    { label: "IP Version", value: `IPv${data.version}`, icon: "Tag" },
    { label: "Hostname", value: data.hostname, icon: "Tag", mono: true },
    { label: "Country", value: `${data.country} ${data.countryCode}`, icon: "MapPin" },
    { label: "Region", value: data.region, icon: "MapPin" },
    { label: "City", value: data.city, icon: "Building2" },
    { label: "Postal Code", value: data.postalCode, icon: "MapPin" },
    { label: "Continent", value: data.continent, icon: "Globe" },
    { label: "Latitude", value: String(data.lat), icon: "MapPin", mono: true },
    { label: "Longitude", value: String(data.lon), icon: "MapPin", mono: true },
    { label: "Timezone", value: data.timezone, icon: "Clock" },
    { label: "Local Time", value: data.localTime, icon: "Clock" },
    { label: "ISP", value: data.isp, icon: "Building" },
    { label: "Organization", value: data.org, icon: "Building" },
    { label: "ASN", value: data.asn, icon: "Tag", mono: true },
    { label: "Currency", value: data.currency, icon: "DollarSign" },
    { label: "Calling Code", value: data.callingCode, icon: "Phone" },
  ];
