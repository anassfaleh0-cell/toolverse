...
export function UrlEncoder() {
  ...
  function compute(val: string, m: Mode) {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : m === "encode" ? "Failed to encode" : "Invalid URL-encoded input");
      setOutput("");
    }
  }
    ...
    <div className="mx-auto max-w-3xl">
      <div className="space-y-3">
        <Textarea
          ...
          placeholder="Enter text to URL-encode or percent-encoded string to decode..."
          rows={8}
