    ...
    <>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <RelatedTools
            tools={[
              { icon: "ðŸ“", title: "Word Counter", description: "Count words, characters, sentences, and reading time", href: "/word-counter" },
              { icon: "ðŸ§¹", title: "Text Cleaner", description: "Clean text with extra spaces, special chars, and HTML tags", href: "/text-cleaner" },
              { icon: "ðŸ”", title: "Find and Replace", description: "Find and replace text with case and regex options", href: "/find-and-replace" },
              { icon: "ðŸ”—", title: "Text to Slug Converter", description: "Convert text to URL-friendly slugs", href: "/text-to-slug" },
            ]}
