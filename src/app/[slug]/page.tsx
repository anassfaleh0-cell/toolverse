...
import { LANDING_PAGES, getLandingPage, getAllLandingSlugs } from "@/lib/seo/landing-pages";
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: page.getTitle(), description: page.getDescription() },
    twitter: { title: page.getTitle(), description: page.getDescription() },
  };
}
