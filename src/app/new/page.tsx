...
export const metadata: Metadata = {
  title: `Newly Added Tools â€” ${SITE_NAME}`,
  ...
  openGraph: { title: `Newly Added Tools â€” ${SITE_NAME}`, description: `Check out the latest tools added to ${SITE_NAME}. Fresh utilities and features added regularly.`, url: `${SITE_URL}/new` },
...
export default function NewPage() {
  ...
  return (
    <>
      <JsonLd data={webPageSchema({ name: `Newly Added Tools â€” ${SITE_NAME}`, description: `Explore the newest tools on ${SITE_NAME}.`, url: `${SITE_URL}/new`, breadcrumbs })} />
