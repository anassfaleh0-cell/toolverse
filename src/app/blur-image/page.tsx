        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <RelatedTools
            tools={[
              ...
              { icon: "✂️", title: "Crop Image", description: "Crop images to focus on specific areas", href: "/crop-image" },
              { icon: "📦", title: "Image Compressor", description: "Compress images to reduce file size", href: "/image-compressor" },
