    ...
    <>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <RelatedTools
            tools={[
              { icon: "ðŸ”“", title: "Base64 to Image", description: "Decode Base64 strings back to viewable images", href: "/base64-to-image" },
              { icon: "ðŸ“¦", title: "Image Compressor", description: "Compress images before Base64 encoding to reduce string size", href: "/image-compressor" },
              { icon: "ðŸ“‹", title: "Image Metadata Viewer", description: "View EXIF and metadata from your images", href: "/image-metadata-viewer" },
              { icon: "ðŸ”„", title: "Image Converter", description: "Convert images between different formats before encoding", href: "/image-converter" },
            ]}
