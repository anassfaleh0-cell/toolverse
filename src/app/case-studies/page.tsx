...
const caseStudies: CaseStudy[] = [
  {
    ...
    subtitle: "How an online retailer used Nuvora DNS tools to detect and fix misconfigurations before they caused outages",
    industry: "E-Commerce",
  ...
  },
  {
    ...
    title: "Security Consultancy Uses Nuvora for Rapid Assessments",
...
export default function CaseStudiesPage() {
  return (
    <>
      <JsonLd data={webPageSchema({ name: `Case Studies — How Professionals Use Nuvora | ${SITE_NAME}`, description: `Real-world case studies from e-commerce, web development, security, and content teams using Nuvora tools.`, url: `${SITE_URL}/case-studies`, breadcrumbs })} />
          ...
          <div className="mt-4 flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-4 text-lg text-zinc-600 dark:text-zinc-400">
                See how businesses and professionals use Nuvora tools to solve real-world challenges, reduce costs, and improve their workflows.
              </p>
            </div>
            <SocialShare url={`${SITE_URL}/case-studies`} title="Case Studies — How Professionals Use Nuvora" />
          </div>
        </div>
      </section>
