...
export const metadata: Metadata = {
  title: `Most Popular Tools â€” ${SITE_NAME}`,
  ...
  openGraph: { title: `Most Popular Tools â€” ${SITE_NAME}`, description: `Browse the most popular tools on ${SITE_NAME}, handpicked and loved by users worldwide.`, url: `${SITE_URL}/popular` },
...
export default function PopularPage() {
  ...
  return (
    <>
      <JsonLd data={webPageSchema({ name: `Most Popular Tools â€” ${SITE_NAME}`, description: `Discover the most popular tools on ${SITE_NAME}.`, url: `${SITE_URL}/popular`, breadcrumbs })} />
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {popularTools.map((t) => (
              ...
              >
                ...
                <h2 className="text-base font-semibold text-text-primary group-hover:text-nuvora-600 dark:group-hover:text-nuvora-600">
                  {t.name}
                </h2>
