  ...
  return (
    <>
      <JsonLd data={{
        ...
        description: "Content Strategist & SEO Specialist at Nuvora with 7 years of experience, former Moz. Creates SEO and content tools.",
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <div className="mt-12">
            ...
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-500">
              Tools built and maintained by Priya at Nuvora:
            </p>
