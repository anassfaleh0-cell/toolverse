...
const DNS_RECORD_TYPES: DnsRecordType[] = [
  ...
  { type: "SOA", fullName: "Start of Authority Record", purpose: "Provides administrative information about the DNS zone, including the primary name server, responsible email, and timing parameters.", format: "example.com.  IN  SOA  ns1.example.com. admin.example.com. 2025010101 3600 900 604800 86400", example: "Primary NS: ns1.example.com, Serial: 2025010101, Refresh: 3600s", whenToUse: "Required at the top of every DNS zone file. Automatically managed by DNS hosting providers.", rfc: "RFC 1035" },
  ...
  { type: "RRSIG", fullName: "Resource Record Signature", purpose: "Contains a cryptographic signature for a DNSSEC-signed record set.", format: "example.com.  IN  RRSIG  A 5 2 86400 20250101000000 20241201000000 12345 example.com. ...", example: "Signature for A record set, valid from Dec 2024 to Jan 2025", whenToUse: "Automatic part of DNSSEC; generated and managed by DNS hosting providers when DNSSEC is enabled.", rfc: "RFC 4034" },
