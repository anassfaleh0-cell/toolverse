    ...
    <>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <RelatedTools
            tools={[
              { icon: "Lock", title: "SSL Certificate Checker", description: "Validate SSL certificates and expiry", href: "/ssl-certificate-checker" },
              { icon: "Lock", title: "TLS Versions Guide", description: "Compare SSL vs TLS protocols", href: "/tls-versions" },
