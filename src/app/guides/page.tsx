...
export const metadata: Metadata = {
  ...
  openGraph: { title: `Guides - ${SITE_NAME}`, description: `Network troubleshooting guides and tutorials.` },
  twitter: { title: `Guides - ${SITE_NAME}`, description: `Network troubleshooting guides and tutorials.` },
