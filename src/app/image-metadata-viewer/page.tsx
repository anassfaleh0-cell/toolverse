    ...
    <>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <RelatedTools
            tools={[
              { icon: "ðŸ”—", title: "Image to Base64", description: "Convert images to Base64 data URI strings", href: "/image-to-base64" },
              { icon: "ðŸ”“", title: "Base64 to Image", description: "Decode Base64 strings back to viewable images", href: "/base64-to-image" },
              { icon: "ðŸ“¦", title: "Image Compressor", description: "Compress images without losing metadata", href: "/image-compressor" },
              { icon: "ðŸ”„", title: "Image Converter", description: "Convert between image formats preserving metadata", href: "/image-converter" },
            ]}
