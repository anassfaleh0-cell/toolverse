...
export const FOOTER_LINKS = [
  ...
  {
    heading: "Tools by Type",
    links: [
      { href: "/convert", label: "Converters" },
      { href: "/for/tools-for-developers", label: "For Developers" },
      { href: "/for/tools-for-designers", label: "For Designers" },
      { href: "/for/tools-for-writers", label: "For Writers" },
      { href: "/for/tools-for-marketers", label: "For Marketers" },
      { href: "/for/tools-for-students", label: "For Students" },
    ],
  },
  {
    heading: "Company",
    links: [
      ...
      { href: "/authors/founder", label: "Founder" },
