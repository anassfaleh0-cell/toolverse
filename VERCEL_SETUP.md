...
4. Root directory: `./` (or `./Nuvora` if monorepo)
...
|------|----------|---------|
| `NEXT_PUBLIC_SITE_URL` | Yes | `https://Nuvora.dev` |
...
- [ ] Visit `https://Nuvora.vercel.app` — loads correctly
- [ ] Run `curl https://Nuvora.vercel.app/robots.txt` — returns valid robots
- [ ] Run `curl https://Nuvora.vercel.app/sitemap.xml` — returns valid sitemap index
